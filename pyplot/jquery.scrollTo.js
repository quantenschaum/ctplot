 ...
 * MIT and GPL. Date: 3/9/2009
 * 
 * @projectDescription Easy element scrolling using jQuery.
 *                     http://flesler.blogspot.com/2007/10/jqueryscrollto.html
 *                     Works with jQuery +1.2.6. Tested on FF 2/3, IE 6/7/8,
 *                     Opera 9.5/6, Safari 3, Chrome 1 on WinXP.
 * 
 ...
 *            kind of number/string like above. - The string 'max' for
 *            go-to-end.
 * @param {Number}
 *            duration The OVERALL length of the animation, this argument can be
 *            the settings object instead.
 * @param {Object,Function}
 *            settings Optional set of settings or the onAfter callback.
 ...
 * @example $('div').scrollTo( { top: 300, left:'+=200' }, { axis:'xy',
 *          offset:-20 } );
 */
;
(function($) {
	...
	$.fn.scrollable = function() {
		return this
				.map(function() {
					var elem = this, isWin = !elem.nodeName
					...
					return $.browser.safari || doc.compatMode == 'BackCompat' ? doc.body
							: doc.documentElement;
				});
	};
	...
	$.fn.scrollTo = function(target, duration, settings) {
		...
		return this
				...
				.each(
						function() {
							var elem = this, $elem = $(elem), targ = target, toff, attr = {}, win = $elem
									.is('html,body');
									...
									.each(
											...
											function(i, axis) {
												var Pos = axis == 'x' ? 'Left'
														...
														+ Pos, old = elem[key], Dim = axis == 'x' ? 'Width'
														: 'Height';
												...
												if (!i && settings.queue) {
													// Don't waste time
													// animating, if there's no
													// need.
													if (old != attr[key])
														// Intermediate
														// animation
														animate(settings.onAfterFirst);
													// Don't animate this axis
													// again in the next
													// iteration.
													delete attr[key];
												}
